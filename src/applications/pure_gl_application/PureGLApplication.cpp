...
PureGLApplication::PureGLApplication(V8Runner *runner) {
    _runner = runner;
}

PureGLApplication::~PureGLApplication() {
    _window = NULL;
    _runner = NULL;
}

int PureGLApplication::OpenWindow() {
